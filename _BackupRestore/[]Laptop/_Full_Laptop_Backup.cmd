...
set BackupsDir=%sDriveLetter%\LSS\___OS_BackUps\_BackupsArchive
...
if %isStep% LEQ 7 (
	if not %isStep% == 0 (
		...
		if %isStep% GEQ 4 (
			...
			if %isStep% == 5 (
				if exist "!Dir[5]!\Microsoft\Skype for Desktop\" (
		...
		if %isStep% == 0 (
			...
			@rem Desktop
			if exist "C:\LSS\Users\New\Desktop\" (
