...
@rem ============================================== Init End ====================================================================
@rem Logs
wmic /OUTPUT:%Commandline% process where (Name="cmd.exe") get Caption,Processid,InstallDate,Commandline,ExecutablePath
@tasklist /v /fo csv | findstr /i "%TaskKillProcessName%" > %LogsDir%\CMDParentPID.txt
