...
start /b /wait F:\_BackupRestore\7za\7za.exe a -t7z -ssw -mx9 -slp -scsWIN -mmt=4 -ms=off "%TempBackupDir%\Local.7z" "%TempBackupDir%\" -r0 -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
