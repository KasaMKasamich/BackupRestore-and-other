...
set 7z_List[2]="19.9.2.229", "SetupMetrics", "YandexDictionaries"
rem 
rem  Self Backup
...
!7za! u -y !7zaKeyString! "%TempBackupDir%\TempYandex\Updater.7z" "%AppDataDir[2]%" -w"%Temp%" @"!7z_List[1]!"
cd /D %userprofile%\AppData\Local\
!7za! u -y !7zaKeyString! "%TempBackupDir%\TempYandex\Application.7z" "%AppDataDir[3]%" -w"%Temp%" @"!7z_List[1]!"
cd /D "C:\Program Files (x86)\"
!7za! u -y !7zaKeyString! "%TempBackupDir%\TempYandex\Service_Update.7z" "%AppDataDir[4]%" -w"%Temp%" @"!7z_List[1]!"
...
!7za! u -y !7zaKeyString! "%TempBackupDir%\%FileName[1]%.7z" %AppDataDir[3]%\*.* -w"%Temp%" -xr@"!7z_List[1]!"
!7za! u -y !7zaKeyString! "%TempBackupDir%\%FileName[1]%.7z" %AppDataDir[3]%\%version% -w"%Temp%" -xr@"!7z_List[1]!"
