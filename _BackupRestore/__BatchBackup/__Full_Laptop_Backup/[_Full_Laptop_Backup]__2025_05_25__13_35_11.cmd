...
if %isStep% LEQ 7 (
	if not %isStep% == 0 (
		...
		if %isStep% == 0 (
			ROBOCOPY "C:\LSS\Users" "D:\LSS\Users" %RCParams3% /LOG:"!RCLogFile!" %RCFileDataFlags%
			ROBOCOPY "C:\[]ProgramFiles" "D:\LSS\[]ProgramFiles" %RCParams3% /LOG:"!RCLogFile!" %RCFileDataFlags%
