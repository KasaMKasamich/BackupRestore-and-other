...
Gpedit.msc
@pause
powershell -Command Import-StartLayout -LayoutPath "Users\%USERNAME%\DefaultLayouts.xml" -MountPath C:\
:: powershell -Command Import-StartLayout -LayoutPath "F:\Archive\_BackUps\_BackupsArchive\2022_04_14__09_12_36_New_Backup_Full\Users\New\DefaultLayouts.xml" -MountPath C:\
taskkill /F /T /IM Explorer.exe
@timeout /t 3 >nul
explorer
@rem ======================================================================
cmd /c C:\_BackupRestore\_ImportTasks\ImportTaskBackUpFull.cmd
cmd /c "%sDriveLetter%\Archive\Sys1\Drivers\VC_Redist\Install_all.cmd"
@rem 
chcp 1251 >nul
start /WAIT "%sDriveLetter%\Archive\Sys1\Drivers\DirectX\12\dxwebsetup.exe"
@rem ======================================================================
start /WAIT "%sDriveLetter%\Archive\_ReinstallApps\Обзор\Yandex\Yandex.exe"
xcopy "!Dir[1]!\Yandex" "!Dir[5]!" /Y /Z /K /E
del /F /S /Q "!Dir[5]!\Yandex\YaPin\"
del /F /S /Q "!Dir[5]!\Yandex\YaPinIcons\"
%sDriveLetter%\ProgramFiles\Sys\NirCMD\nircmd.exe shortcut "C:\Program Files (x86)\Yandex\YandexBrowser\Application\browser.exe" ~$folder.desktop$" "Yandex" ""%"YandexBrowserSwitches"%"" "C:\Program Files (x86)\Yandex\YandexBrowser\Application\browser.exe" 0
...
MOVE /Y "Program Files (x86)\SkypeForDesktop_x86.7z" SkypeForDesktop_x86.7z
@rem ======================================================================
!7za! x "Users\New\AppData\LocalLow\*.7z" -o"!Dir[0]!"
!7za! x "Users\New\AppData\Local\*.7z" -o"!Dir[1]!"
!7za! x "Users\New\AppData\Roaming\*.7z" -o"!Dir[2]!"
!7za! x "Users\Public\*.7z" -o"!Dir[3]!"
!7za! x "Program Files\*.7z" -o"!Dir[4]!"
!7za! x "Program Files (x86)\*.7z" -o"!Dir[5]!"
!7za! x SkypeForDesktop_x86.7z -o"!Dir[5]!"
!7za! x "ProgramData\*.7z" -o"!Dir[6]!"
@rem ======================================================================
!7za! x "Users\New\New.7z" -o"!userprofile!"
@rem ======================================================================
MOVE /Y SkypeForDesktop_x86.7z "Program Files (x86)\SkypeForDesktop_x86.7z"
@rem ======================================================================
