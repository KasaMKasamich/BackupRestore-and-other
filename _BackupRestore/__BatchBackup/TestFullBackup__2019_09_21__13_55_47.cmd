...
rem start /b /wait 
F:\_BackupRestore\7z\1900\x64\7za.exe u -r- -mx9 "%TempBackupDir%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
F:\_BackupRestore\7z\1900\x64\7za.exe u -r- -m9=LZMA2:d128m:fb256 -myx9 -mmt=16 -ms=off "%TempBackupDir%\Viber2.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
F:\_BackupRestore\7z\1900\x64\7za.exe u -r- -m9=LZMA2:d128m:fb256 -myx9 -slp -mmt=16 -ms=off "%TempBackupDir%\Viber3.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
