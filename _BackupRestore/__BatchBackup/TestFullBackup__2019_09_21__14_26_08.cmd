...
rem start /b /wait 
F:\_BackupRestore\7za\7za.exe u -ssw -mx9 "%TempBackupDir%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
F:\_BackupRestore\7za\7za.exe u -ssw -mx9 -r- "%TempBackupDir%\Viber2.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
