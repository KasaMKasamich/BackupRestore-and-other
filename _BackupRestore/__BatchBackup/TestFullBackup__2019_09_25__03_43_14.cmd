...
set TempAppData[0]=C:\_BR\Users\%USERNAME%\AppData\Local"
set TempAppData[1]=C:\_BR\Users\%USERNAME%\AppData\LocalLow"
set TempAppData[2]=C:\_BR\Users\%USERNAME%\AppData\Roaming"
set TempUsersDir[0]=C:\_BR\%UsersDir[0]%"
...
rem call :Test
:Test
rem !7za! u -y -r !7zaKeyString! "%TempAppData[0]%\Local.7z" "%TempDirNBP%\Local\*" -w"%Temp%"
set Source=`!TempAppData[%isStep%]!`
for /f "usebackq delims=" %%i in (`!TempAppData[%isStep%]!`) Do ( set Source=`!TempAppData[%isStep%]!` )
@echo - %Source%
!7za! u -y -r !7zaKeyString! "%Source%\Local.7z" "%TempDirNBP%\Local\*" -w"%Temp%" '-x@"!ListLocalExclude!"' '-xr@"!ListRecurseExclude!"'
...
rem !7za! u -y -r !7zaKeyString! "!TempAppData[%isStep%]!\Microsoft\Credentials.7z" "%Dir[0]%\Microsoft\Credentials"
rem !7za! u -y -r !7zaKeyString! "!TempAppData[%isStep%]!\Microsoft\Credentials.7z" "%Dir[2]%\Microsoft\Credentials"
rem !7za! u -y -r !7zaKeyString! "!TempAppData[%isStep%]!\Microsoft\Crypto.7z" "%Dir[2]%\Microsoft\Crypto"
...
@timeout /t 1 >nul
if not %isStep% == 1 (
	!7za! u -y -r !7zaKeyString! "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" "%TempDirNBP%\!FileN[%isStep%]!\*" -w"%Temp%"
) else (
	!7za! u -y -r !7zaKeyString! "%TempAppData[1]%\%FileN[1]%.7z" "%Dir[1]%\*" -w"%Temp%"
)
echo [92m " =================================== Pause =================================== " [0m 
@timeout /t 360 >nul
:: 
