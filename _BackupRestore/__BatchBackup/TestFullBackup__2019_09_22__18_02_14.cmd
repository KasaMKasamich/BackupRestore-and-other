...
set RCLocalExcludeDir="Vivox" "IceDragon" "Logs" "Recent" "Report*" "Temporary*" "*Crash*" "*Temp*" "*History*" "*Log*" "Application*" "Microsoft" "Diagnostics" "Packages" "Comms" "NVIDIA*" "Programs" "Publishers" "TempCheckUpdate" "fontconfig" "{*}" "*Folder" "e2eSoft" "speech" "TechSmith" "*Tile*" "Wondershare" "VirtualStore" "ConnectedDevicesPlatform"
...
For /D %%A In ("%TempSourceBackupGTRDir%\*") Do (
	if %%B geq !MB! !7za! u -y -r !7zaKeyString! "!TempBackupDir!\%%~nxA.7z" "%%A" -x@"!ListLocalExclude!" -xr@"!ListRecurseExclude!"
)
