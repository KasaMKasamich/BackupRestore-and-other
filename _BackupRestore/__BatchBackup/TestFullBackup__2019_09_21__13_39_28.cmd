...
F:\_BackupRestore\7z\1900\x64\7za.exe u -r- -m9=LZMA2:d128m:fb256 -myx9 -mmt=16 -ms=off "%TempBackupDir%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
