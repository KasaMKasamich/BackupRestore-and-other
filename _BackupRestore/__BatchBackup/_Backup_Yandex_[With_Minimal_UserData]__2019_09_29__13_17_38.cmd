...
@rem !7za! u -y !7zaKeyString! "%TempBackupDir%\TempYandex\Application.7z" "%AppDataDir[3]%" -w"%Temp%" @"!7z_List[1]!"
%7za% u -y !7zaKeyString! "%TempBackupDir%\Application.7z" -w"%Temp%" @"%7z_List[2]%"
