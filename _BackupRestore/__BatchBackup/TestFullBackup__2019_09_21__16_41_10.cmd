...
:log
cd /D C:\_BR\Viber\
Echo WScript.StdIn.AtEndOfStream::WScript.Echo Round(CreateObject("Scripting.FileSystemObject").GetFolder(WScript.StdIn.ReadLine).Size/2^^20,2)>GetDirSize.vbs
For /D %%A In ("C:\_BR\Viber\*") Do (
	For /F "delims=" %%B In ('CScript //Nologo C:\_BR\Viber\GetDirSize.vbs "%%A"') Do (
		...
		if !FloatMB! geq 100 Echo Size of %%A is !FloatMB! MB. >> %ListDir%\ListFileViber.txt
	)
)
:End
