...
@timeout /t 5 >nul
		@rem Users\Public
		if %isStep% == 3 (
			!7za! u -y !7zaKeyString2! "!TempOutputDir[%isStep%]!\!FileN[%isStep%]!.7z" @"!7z_List[%isStep%]!"
		)
		@rem Program Files...
		if %isStep% GEQ 4 (
			@rem Program Files...
			if %isStep% LEQ 5 (
				!7za! u -y !7zaKeyString2! "!TempOutputDir[%isStep%]!\Common Files.7z" -w"%Temp%" @"!7z_ListCommonFiles[%isStep%]!"
			)
			if %isStep% == 5 (
				!7za! u -y !7zaKeyString2! "!TempOutputDir[5]!\SkypeForDesktop_x86.7z" "Microsoft\Skype for Desktop\" -w"%Temp%"
				!7za! u -y !7zaKeyString2! "!TempOutputDir[5]!\Steam.7z" -w"%Temp%" @"%ListDir%\7z_Steam.txt"
				!7za! u -y !7zaKeyString2! "!TempOutputDir[5]!\Microsoft Visual Studio.7z" "!Dir[%isStep%]!\Microsoft Visual Studio\" -w"%Temp%"
				!7za! u -y !7zaKeyString2! "!TempOutputDir[5]!\Nox.7z" "!Dir[%isStep%]!\Nox\" -w"%Temp%"
			)
			if %isStep% LEQ 6 (
				For /D %%A In ("!Dir[%isStep%]!\*") Do (
					if "!Dir[%isStep%]!\%%~nxA" == "%%A" (
						!7za! u -y -r0 !7zaKeyString2! "!TempOutputDir[%isStep%]!\%%~nxA.7z" "%%A" -x@"!7z_ExcludeList[%isStep%]!"
					)
				)
			)
		)
