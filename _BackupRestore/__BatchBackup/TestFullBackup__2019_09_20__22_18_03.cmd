...
@timeout 2 >nul
start /b /REALTIME /wait F:\_BackupRestore\7z\1900\x64\7za.exe a -y -ssw "%TempBackupDir%\2.7z" "%TempSourceBackupDir%\*" -r0 -w"%TempBackupDir%" -i@"%ListLocalInclude%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%" -bse1 -slp -scsWIN -mmt=on -mx9 -ms=off > %LogsDir%\%FileNameSec01%_Local_7z.log
