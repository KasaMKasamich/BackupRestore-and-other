...
7za.exe u -ssw -r- -m0=LZMA2:d128m:fb256 -myx9 -slp -mmt=32 -ms=off "%TempBackupDir%\Local.7z" "%TempSourceBackupDir%" -w"%Temp%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
:: 
pause
