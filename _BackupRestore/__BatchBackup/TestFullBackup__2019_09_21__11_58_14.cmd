...
start /b /wait F:\_BackupRestore\7z\1900\x64\7za.exe u -t7z -r0 -ssw -m9=LZMA2 -md=64 -mfb=64 -mx=9 -myx=9 -slp -scsWIN -mmt=4 -mmtf=on -ms=off -y "%Dir001%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
