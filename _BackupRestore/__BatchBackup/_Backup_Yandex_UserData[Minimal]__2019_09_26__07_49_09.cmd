:: User Data(Minimal)
@rem F:\_BackupRestore\_Backup_Yandex_UserData[Minimal].cmd
@echo on
...
rem  Папки
set AppDataDir[0]=%userprofile%\AppData\LocalLow\Yandex
@rem \Updater
@rem C:\Users\New\AppData\Local\Yandex\YandexBrowser\Application
set AppDataDir[1]=%userprofile%\AppData\Local\Yandex
set AppDataDir[2]=%userprofile%\AppData\Roaming\Yandex
...
rem  Files
set FileName=_UserData[Minimal]
set LogFileName=_Backup_Yandex_UserData(Minimal)
...
!7za! u -y !7zaKeyString! "%TempBackupDir%\%TimeStamp%_%FileName%.7z" -w"%Temp%" @"!7z_List[0]!"
:End
echo [92m " ========================================== End ========================================== " [0m
@timeout /t 2 >nul
endlocal
