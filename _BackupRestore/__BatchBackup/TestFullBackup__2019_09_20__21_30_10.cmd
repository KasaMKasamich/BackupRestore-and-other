...
@timeout 2 >nul
start /b /REALTIME /wait F:\_BackupRestore\7z\1900\x64\7za.exe a -ssw "%TempBackupDir%\2.7z" "%TempSourceBackupDir%\*" -r0 -w"%TempBackupDir%" -i@"%ListLocalInclude%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%" -bsp2 -slp -scsWIN -mmt=2 -mx9 -ms=off
...
For /D %%A In ("%TempSourceBackupDir%\*") Do (
	start /b /REALTIME /wait F:\_BackupRestore\7z\1900\x64\7za.exe a -ssw "%TempBackupDir%\%%~nxA.7z" "%%A" -r0 -w"%TempBackupDir%" -i@"%ListLocalInclude%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%" -bsp2 -bse2 -slp -scsWIN -mmt=2 -mx9 -ms=off
)
@timeout 2 >nul
