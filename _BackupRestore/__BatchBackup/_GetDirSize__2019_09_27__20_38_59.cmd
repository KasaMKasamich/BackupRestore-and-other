...
set isSandbox=1
set isRunAs=1
if defined %~1 ( set %isRunAs%=0 )
if %DM% == 1 (
	if %isRunAs% == 1 ( set /A isRunAs=0 | pause | powershell -Command "Start-Process %self% "%isRunAs%" -Verb RunAs" )
@rem >> ===================================
echo --  %0
echo --  %~dp0
echo --  %~n0
...
rem echo %errorlevel%
xcopy GetDirSize.vbs %~dp1%~n1\GetDirSize.vbs /R /Y /O /X
echo %errorlevel%
if errorlevel 4 (
	call :RunAs
	goto :End
