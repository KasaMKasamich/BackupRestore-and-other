...
rem Echo WScript.Echo Round(CreateObject("Scripting.FileSystemObject").GetFolder(WScript.Arguments(0)).Size/1^^20,6)>GetDirSize.vbs
for /f "usebackq delims=;" %%A in (`dir /c /b *.*`) do (
