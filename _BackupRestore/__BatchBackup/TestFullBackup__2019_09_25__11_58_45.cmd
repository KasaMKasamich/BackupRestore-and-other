...
if not %isStep% == 0 (
	cd /D !Dir[%isStep%]!\
	!7za! u -y !7zaKeyString! "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" @"!7z_List[%isStep%]!" -w"%Temp%" '-xr@"!7z_ExcludeRecurseFiles!"'
	!7za! d -y "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" desktop.ini -r
...
::  Users\UserProfile
cd /D %userprofile%\
!7za! u -y !7zaKeyString! "%TempBackupDir%\Users\%USERNAME%\%USERNAME%.7z" @"!7z_List[3]!" -w"%Temp%" '-xr@"!7z_ExcludeRecurseFiles!"'
!7za! d -y "%TempBackupDir%\Users\%USERNAME%\%USERNAME%.7z" desktop.ini -r
::  Users\Public
cd /D C:\%UsersDir[0]%\
!7za! u -y !7zaKeyString! "%TempBackupDir%\%UsersDir[0]%\Public.7z" @"!7z_List[4]!" '-xr@"!7z_ExcludeRecurseFiles!"'
!7za! d -y "%TempBackupDir%\%UsersDir[0]%\Public.7z" desktop.ini -r
:: 
exit /b
