...
set 7z_IncludeListLocal=%ListDir%\7z_IncludeLocal.txt
set 7z_IncludeListRoaming=%ListDir%\7z_IncludeRoaming.txt
...
:Test
if not %isStep% == 1 (
	!7za! u -y -r !7zaKeyString! "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" "%TempDirNBP%\!FileN[%isStep%]!\*" @"%7z_IncludeListLocal%"
)
