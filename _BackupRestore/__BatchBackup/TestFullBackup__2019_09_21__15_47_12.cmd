...
rem 7za.exe u -ssw -mx9 "%TempBackupDir%\Viber2.7z" "%Dir001%\Viber"

7za.exe u %7zaKeyString% "%TempSourceBackupDir%\Local.7z" "%TempBackupDir%" -w"%Temp%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
:: 
pause
