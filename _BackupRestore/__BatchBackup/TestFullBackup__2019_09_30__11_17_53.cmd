...
set FileNCommonFiles[4]=CommonFiles
set FileNCommonFiles[5]=CommonFiles_x86
...
set /a isStep=!isStep!+1
		...
		if %isStep% GEQ 4 (
			@rem Program Files...
			if %isStep% LEQ 5 (
				!7za! u -y !7zaKeyString! "!TempOutputDir[%isStep%]!\!FileNCommonFiles[%isStep%]!.7z" -w"%Temp%" @"!7z_ListCommonFiles[%isStep%]!"
			)
			if %isStep% LEQ 6 (
