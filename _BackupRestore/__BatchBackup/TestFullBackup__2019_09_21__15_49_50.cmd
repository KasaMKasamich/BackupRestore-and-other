...
7za.exe u -y -ssw -r- -m0=LZMA2:d128m:fb256 -myx9 -slp -mmt=32 -ms=off "%TempSourceBackupDir%\Local.7z" "%TempBackupDir%" -w"%Temp%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
:: 
pause
