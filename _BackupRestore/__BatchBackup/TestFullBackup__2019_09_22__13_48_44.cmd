...
ROBOCOPY %Dir001%\NVIDIA\accounts. %TempBackupDir%\NVIDIA\ %RCParams% /LOG:"%RCLogFile%" %RCFileDataFlags%
@timeout /t 91 >nul
...
rem xcopy %Dir001%\NVIDIA\accounts. %TempBackupDir%\NVIDIA\ /S /R /Y /Z /K /E
