...
rem  `-x!.tmp` `-x!.cookie` `-x!.log` `-x!.vbs` `-x!.7z`
!7za! u -y -r- !7zaKeyString! "%TempBackupDir%\Local.7z" "%TempSourceBackupDir%\*" -w"%Temp%" -x@"%ListLocalExclude%" -xr0@"%ListRecurseExclude%"
...
rem start /b /wait 
!7za! u !7zaKeyString! "%TempBackupDir%\Local.7z" "%TempSourceBackupDir%\*" -w"%Temp%" -x@"%ListLocalExclude%" -xr0@"%ListRecurseExclude%"
