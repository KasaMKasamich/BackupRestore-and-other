...
rem start /b /wait 
F:\_BackupRestore\7z\1900\x64\7za.exe u -ssw -r- -m0=LZMA2:x9:d128m:fb256 -myx9 -slp -mmt=32 -ms=off "%TempBackupDir%\Viber3.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
