...
For /D %%A In ("C:\_BR\Viber Media Sarl\*") Do (
	For /F "delims=" %%B In ('CScript //Nologo C:\_BR\Viber Media Sarl\GetDirSize.vbs "%%A"') Do (
		Set Bytes=%%B
		Set /A IntMB=!Bytes!/1048576
		Set /A IntKB=!Bytes!/1024
		Set /A FloatMB=!Bytes!%%1048576/10000
		Set /A FloatKB=!Bytes!%%1024/10
		if !IntMB! leq 100 Echo Size of %%A is !FloatMB! MB. >> %ListDir%\ListFileViber.txt
	)
)
:End
