...
@timeout 2 >nul
start /REALTIME /wait F:\_BackupRestore\7z\1900\x64\7za.exe a -ssw "%TempBackupDir%\2.7z" "%TempSourceBackupDir%\*" -r0 -w"%TempBackupDir%" -i@"%ListLocalInclude%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%" -bsp2 -slp -scsWIN -mmt=4 -mx9 -ms=off >> %LogsDir%\%FileNameSec01%_2_7z.log
...
For /D %%A In ("%TempSourceBackupDir%\*") Do (
	start /REALTIME /wait F:\_BackupRestore\7z\1900\x64\7za.exe a -ssw "%TempBackupDir%\%%~nxA.7z" "%%A" -r0 -w"%TempBackupDir%" -i@"%ListLocalInclude%" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%" -bsp2 -bse2 -slp -scsWIN -mmt=4 -mx9 -ms=off >> %LogsDir%\%FileNameSec01%_%%~nxA_7z.log
)
@timeout 2 >nul
