...
@rem 
set /a isStep=!isStep!+1
echo -- isStep = %isStep% rem =============================================================================================
cd /D !Dir[%isStep%]!\
if not exist %Dir[3]%\GetDirSize.vbs ( Echo "WScript.Echo CreateObject("Scripting.FileSystemObject").GetFolder(WScript.Arguments(0)).Size">GetDirSize.vbs )
@timeout /t 5 >nul
		@rem Users\Public
		if %isStep% == 3 (
