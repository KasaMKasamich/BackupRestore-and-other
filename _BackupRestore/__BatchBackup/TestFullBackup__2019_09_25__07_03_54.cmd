...
@rem set isStep=0
echo ======================================================
!7za! u -y !7zaKeyString! "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" "!Dir[%isStep%]!\" @C:\_BackupRestore\__Lists\7z_Local.txt
...
::  AppData\Local
@rem xcopy %Dir[0]%\NVIDIA\accounts. %TempDirNBP%\%FileN[0]%\NVIDIA\ /R /Y /O /X
!7za! u -y -r !7zaKeyString! "!TempAppData[0]!\Microsoft\Credentials.7z" "%Dir[0]%\Microsoft\Credentials"
!7za! u -y -r !7zaKeyString! "!TempAppData[2]!\Microsoft\Credentials.7z" "%Dir[2]%\Microsoft\Credentials"
!7za! u -y -r !7zaKeyString! "!TempAppData[2]!\Microsoft\Crypto.7z" "%Dir[2]%\Microsoft\Crypto"
::  AppData\LocalLow
!7za! u -y -r !7zaKeyString! "%TempAppData[1]%\%FileN[1]%.7z" "%Dir[1]%\*" -w"%Temp%"
::  AppData
if not %isStep% == 0 (
	!7za! u -y !7zaKeyString! "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" "!Dir[%isStep%]!\*" '@"%7z_List[!isStep!]%"'
...
!7za! u -y -r !7zaKeyString! "%TempBackupDir%\Users\%USERNAME%\%USERNAME%.7z" "%userprofile%\*" '@"%7z_List[3]%"'
:: Users\Public
!7za! u -y -r !7zaKeyString! "%TempBackupDir%\%UsersDir[0]%\Public.7z" "C:\%UsersDir[0]%\*" '@"%7z_List[4]%"'
:: 
