...
For /D %%A In ("%TempSourceBackupDir%\*") Do (
	For /F "delims=" %%B In ('CScript //Nologo %TempSourceBackupDir%\GetDirSize.vbs "%%A"') Do (
		if %%B geq !MB! !7za! u -y -r- !7zaKeyString! "!TempBackupDir!\%%~nxA.7z" "%%A" '-xr0!*.tmp' '-xr0!*.dmp' '-xr0!*.cookie' '-xr0!*.log' '-xr0!*.vbs' '-xr0!*.7z' '-xr0!Logs' '-xr0!Temp' '-xr0!Crash' '-xr0!IceDragon' '-xr0!Comodo'
	)
)
