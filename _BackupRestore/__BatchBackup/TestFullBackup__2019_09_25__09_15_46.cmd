...
::  AppData\LocalLow
!7za! u -y -r !7zaKeyString! "%TempAppData[0]%\%FileN[0]%.7z" "%Dir[0]%\*" -w"%Temp%"
::  AppData
if not %isStep% == 0 (
	cd /D !Dir[%isStep%]!\
	!7za! u -y !7zaKeyString! "!TempAppData[%isStep%]!\!FileN[%isStep%]!.7z" @"!7z_List[%isStep%]!" -x!desktop.ini
...
::  Users\UserProfile
cd /D C:\Users\
!7za! u -y !7zaKeyString! "%TempBackupDir%\Users\%USERNAME%.7z" @"!7z_List[3]!"
::  Users\Public
cd /D C:\%UsersDir[0]%\
