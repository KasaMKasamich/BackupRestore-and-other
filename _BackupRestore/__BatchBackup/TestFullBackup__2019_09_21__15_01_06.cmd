...
rem start /b /wait 
F:\_BackupRestore\7za\7za.exe a -ssw -mx9 "%TempBackupDir%\Viber.7z" "%Dir001%\Viber"
F:\_BackupRestore\7za\7za.exe a -ssw -mx9 -r- "%TempBackupDir%\Viber2.7z" "%Dir001%\Viber"
...
F:\_BackupRestore\7z\1900\x64\7za.exe a -ssw -r- -m0=LZMA2:yx9:d128m:fb256 -slp -mmt=32 -ms=off "%TempBackupDir%\Viber4.7z" "%Dir001%\Viber"
F:\_BackupRestore\7z\1900\x64\7za.exe a -ssw -r- -m0=LZMA2:x9:yx9:d128m:fb256 -slp -mmt=32 -ms=off "%TempBackupDir%\Viber5.7z" "%Dir001%\Viber"
