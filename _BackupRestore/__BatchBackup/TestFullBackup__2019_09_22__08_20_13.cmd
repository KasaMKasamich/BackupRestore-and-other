...
rem xcopy %Dir001%\NVIDIA\accounts %TempBackupDir%\NVIDIA\accounts /Y /Z /K /E
rem copy /v /y %Dir001%\NVIDIA\accounts %TempBackupDir%\NVIDIA\accounts
...
if errorlevel 5 echo [92m "Произошла ошибка записи на диск. / Access is denied." [0m "%~n0" rem goto:user_stopped_the_process
