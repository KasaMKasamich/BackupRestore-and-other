...
start /b /wait F:\_BackupRestore\7za\7za.exe u -t7z -r0 -ssw -m9LZMA2 -md64 -mfb64 -mx9 -myx9 -slp -scsWIN -mmt4 -mmtf=on -ms=off -y "%Dir001%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
