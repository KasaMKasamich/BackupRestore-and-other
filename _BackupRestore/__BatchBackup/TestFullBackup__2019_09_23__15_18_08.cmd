...
cd /D %TempSourceBackupDir%\
echo ========================================================
for /F "delims=|" %%i In (!RCLocalExcludeDir!) Do @echo %%i
echo ========================================================
rem for /F "usebackq delims=|" %%i In (`dir /a:d /s /b "!Dir001!\*"`) Do @echo %%i
for /F "usebackq delims=|" %%i In (`dir /a:d /s /b "!ListLocalExclude!\*"`) Do @echo %%i
echo ========================================================

for /d %%A In ("%Dir001%\*") Do (
	rem for /F "delims=|" %%i In (!ListLocalExclude!) Do @echo %%i
	rem for /F "usebackq delims=|" %%i In (`dir /a:d /s /b "!ListLocalExclude!\*"`) Do @echo %%i
	if not "%%~nxA"=="Yandex" (
