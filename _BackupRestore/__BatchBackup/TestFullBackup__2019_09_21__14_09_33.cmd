...
rem start /b /wait 
F:\_BackupRestore\7z\1900\x64\7za.exe u -ssw -mx=9 "%TempBackupDir%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
F:\_BackupRestore\7z\1900\x64\7za.exe u -ssw -mx=9 -r- "%TempBackupDir%\Viber2.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
F:\_BackupRestore\7z\1900\x64\7za.exe u -ssw -r- -m9=LZMA2:d128m:fb256 -myx9 -slp -mmt=32 -ms=off "%TempBackupDir%\Viber3.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
