...
!7za! u -y -r !7zaKeyString! "%TempBackupDir%\!FileN[%isStep%]!.7z" "%TempDir[0]%\*" -w"%Temp%"
:: Если с исключениями:
!7za! u -y -r !7zaKeyString! "%TempBackupDir%\!FileN[%isStep%]!.7z" "%TempDir[0]%\*" -w"%Temp%" -x@"!7z_ExcludeList[%isStep%]!" -xr@"!7z_ExcludeRecurseList[%isStep%]!"
rem <
...
if exist "%TempBackupDir%\LocalLow.7z" if %isStep% == 1 (set isStep=2)
if exist "%TempBackupDir%\Roaming.7z" if %isStep% == 2 (set isStep=3)
if %isStep% != 99 (goto :cleaning)
