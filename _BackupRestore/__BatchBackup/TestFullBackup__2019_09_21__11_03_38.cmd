...
start /b /wait F:\_BackupRestore\7za\7za.exe u -t7z -r0 -ssw -mx9 -slp -scsWIN -mmt=4 -ms=off -y "%TempBackupDir%\Local.7z" "%TempBackupDir%\" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
