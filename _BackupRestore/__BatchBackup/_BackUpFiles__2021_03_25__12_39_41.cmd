...
set OutputDir[0]=%BackupsDir%\Users\%USERNAME%\AppData\LocalLow
set OutputDir[1]=%BackupsDir%\Users\%USERNAME%\AppData\Local
set OutputDir[2]=%BackupsDir%\Users\%USERNAME%\AppData\Roaming
set OutputDir[3]=%BackupsDir%\%UsersDir[0]%
set OutputDir[4]=%BackupsDir%\Program Files
set OutputDir[5]=%BackupsDir%\Program Files (x86)
set OutputDir[6]=%BackupsDir%\ProgramData
