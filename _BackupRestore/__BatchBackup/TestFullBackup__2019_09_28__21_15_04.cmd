...
set 7z_List[5]=%ListDir%\7z_ProgramFiles.txt
set 7z_List[6]=%ListDir%\7z_ProgramFiles_x86.txt
set 7z_List[7]=%ListDir%\7z_ProgramData.txt
...
@rem )
if %isStep% LEQ 2 ( cd /D !TempRoboCopDir[%isStep%]!\ )
@timeout /t 1 >nul
del /F /S /Q *.tmp
del /F /S /Q *.log
del /F /S /Q *.dmp
...
if %isStep% LEQ 2 (
	...
	if not %isStep% == 0 (
		...
		!7za! u -y -r !7zaKeyString! "%TempOutputDir[0]%\%FileN[0]%.7z" "%Dir[0]%\*" -w"%Temp%" '-xr@"!7z_ExcludeRecurseFiles!"'
	)
)
if %isStep% == 0 (
	cd /D %userprofile%\
...
if %isStep% == 3 (
	cd /D !Dir[%isStep%]!\
	!7za! u -y !7zaKeyString! "!TempOutputDir[%isStep%]!\Public.7z" @"!7z_List[4]!"
)
...
rem :: set TempOutputDir[0]=C:\_BR\Program Files
rem :: set TempOutputDir[1]=C:\_BR\Program Files (x86)
rem :: set TempOutputDir[2]=C:\_BR\ProgramData
set FileN[4]=ProgramFiles
set FileN[5]=ProgramFiles_x86
set FileN[6]=ProgramData
set 7z_List[5]=%ListDir%\7z_ProgramFiles.txt
