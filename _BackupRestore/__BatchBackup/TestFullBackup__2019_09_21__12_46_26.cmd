...
::  -md64 -mfb64
::  -myx9
start /b /wait F:\_BackupRestore\7z\1900\x64\7za.exe u -t7z -r0 -ssw -m9=LZMA2 -md64 -mx9 -slp -scsWIN -mmt=4 -ms=off -y "%Dir001%\Viber.7z" "%Dir001%\Viber" -x@"%ListLocalExclude%" -xr@"%ListRecurseExclude%"
